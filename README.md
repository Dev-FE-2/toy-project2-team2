...
<div align="center">
  <h3>급여 관리 효율성을 높이기 위한 급여 및 일정 관리 플랫폼입니다.</h3>
</div>
<br/>
...
### 📅 1. 내 일정
<p align="center">
    <img src="./README_GIF/일정.gif" alt="일정 gif" />
</p>
...
- **이번 달 급여 내역 조회** : 이번 달의 급여 명세서를 가장 먼저 확인할 수 있으며 급여와 관련된 모든 정보를 명확하게 제공합니다.
- **과거 급여 내역 조회** : 날짜를 선택하여 원하는 달의 급여 내역도 쉽게 확인할 수 있고 "이번 달" 버튼을 통해 이번 달 급여 내역을 즉시 확인할 수 있습니다.
...
- **정정 신청 내역 확인** : 신청한 정정 요청을 월별로 목록 형태로 확인할 수 있고, 정정 신청의 상태와 정정 신청 날짜가 표시됩니다.
...
<div align="center">
  <table>
    <tr>
      <td align="center">
        <img src="./README_GIF/마이페이지.gif" alt="My Page" width="350"/>
        <br/>
        <strong>마이페이지</strong>
      </td>
      <td align="center">
        <img src="./README_GIF/로그인.gif" alt="Login Page" width="350"/>
        <br/>
        <strong>로그인</strong>
      </td>
    </tr>
